...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = _director2.default.Router; /*global jQuery, Handlebars, Router */
	...
	(0, _jquery2.default)(function ($) {
		...
		_handlebars2.default.registerHelper('eq', function (a, b, options) {
		...
		var App = {
			init: function init() {
				...
				this.todoTemplate = _handlebars2.default.compile($('#todo-template').html());
				this.footerTemplate = _handlebars2.default.compile($('#footer-template').html());
				this.bindEvents();
			...
			bindEvents: function bindEvents() {
				...
				$('#todo-list').on('change', '.toggle', this.toggle.bind(this)).on('dblclick', 'label', this.edit.bind(this)).on('keyup', '.edit', this.editKeyup.bind(this)).on('focusout', '.edit', this.update.bind(this)).on('click', '.destroy', this.destroy.bind(this));
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	handlebars.Visitor = __webpack_require__(17)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Compiler = __webpack_require__(15).Compiler;
	var compile = __webpack_require__(15).compile;
	var precompile = __webpack_require__(15).precompile;
	var JavaScriptCompiler = __webpack_require__(16)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFrame = __webpack_require__(6).createFrame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var parser = __webpack_require__(13)["default"];
	var AST = __webpack_require__(11)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Visitor = __webpack_require__(17)["default"];
