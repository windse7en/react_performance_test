...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		app.TodoFooter = _react2.default.createClass({
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/',
									className: (0, _classnames2.default)({ selected: nowShowing === app.ALL_TODOS }) },
								'All'
							)
						),
						' ',
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/active',
									className: (0, _classnames2.default)({ selected: nowShowing === app.ACTIVE_TODOS }) },
								'Active'
							)
						),
						' ',
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{
									href: '#/completed',
									className: (0, _classnames2.default)({ selected: nowShowing === app.COMPLETED_TODOS }) },
								'Completed'
							)
						)
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		app.TodoItem = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var TodoApp = _react2.default.createClass({
			...
			render: function render() {
				...
				if (activeTodoCount || completedCount) {
					footer = _react2.default.createElement(TodoFooter, {
		...
		function render() {
			_react2.default.render(_react2.default.createElement(TodoApp, { model: model }), document.getElementsByClassName('todoapp')[0]);
		}
